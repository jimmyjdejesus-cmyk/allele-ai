...
class TestOpenAIClientUnit:
    ...
    @pytest.mark.asyncio
    async def test_initialization_success_with_mocked_openai(self, mock_config, mock_openai_class, mock_openai_client):
    ...
    def test_initialization_model_not_available(self, mock_config, mock_openai_class, mock_openai_client):
    ...
    def test_initialization_authentication_failure(self, mock_config, mock_openai_class, mock_openai_client):
    ...
    def test_estimate_token_count_simple_text(self, mock_config, mock_openai_class, mock_openai_client):
    ...
    def test_estimate_token_count_multiple_messages(self, mock_config, mock_openai_class, mock_openai_client):
    ...
    def test_estimate_token_count_empty_messages(self, mock_config, mock_openai_class, mock_openai_client):
    ...
    def test_estimate_cost_known_models(self, mock_config, mock_openai_class, mock_openai_client):
    ...
    def test_estimate_cost_unknown_model_fallback(self, mock_config, mock_openai_class, mock_openai_client):
    ...
    @patch('time.time')
    def test_get_available_models_with_caching(self, mock_time, mock_config, mock_openai_class, mock_openai_client):
    ...
    @pytest.mark.asyncio
    async def test_chat_completion_parameter_validation(self, mock_config, mock_openai_class, mock_openai_client):
    ...
    @pytest.mark.asyncio
    async def test_chat_completion_with_retry_logic(self, mock_config, mock_openai_class, mock_openai_client):
        ...
        mock_openai_client.chat.completions.create.side_effect = [mock_error, mock_success_response]
    ...
    @pytest.mark.asyncio
    async def test_context_manager_usage(self, mock_config, mock_openai_class, mock_openai_client):
    ...
    def test_close_cleans_up_resources(self, mock_config, mock_openai_class, mock_openai_client):
    ...
    def test_close_handles_errors_gracefully(self, mock_config, mock_openai_class, mock_openai_client):
