...
class TestPerformance:
    ...
    def test_scalability_large_population(self):
        ...
        config = EvolutionConfig(population_size=500, generations=5, mutation_rate=0.1)
    ...
    def test_fitness_evaluation_performance(
        self, population_of_genomes, fitness_function, benchmark
    ):
